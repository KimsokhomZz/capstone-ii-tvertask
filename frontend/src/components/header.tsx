...
export default function Header({ title, icon, titleClassName, containerClassName }: HeaderProps) {
  return (
    <div className={`flex items-center gap-2 text-gray-800 mb-4 ${containerClassName ?? ""}`}>
      {icon && (
